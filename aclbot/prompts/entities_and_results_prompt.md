...

{
  "entities": {
    ...
    "methods": [{"entity": "Expectation-Maximization", "quote": "As none by Smith et al., we optimize the parameters of their model using Expectation-Maximization.", "usage": ["baseline"]}],
  ...
  "results": [
    {"task": "Named Entity Recognition", "dataset": "CoNLL-2003", "metric": "F1-score", "result": 0.923}
  ]
}
